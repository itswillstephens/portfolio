...
const IndexPage = () => (
  <Layout>
    ...
    <p>I started my career co-founding <a href="https//www.beermenus.com" style={{color: 'blue'}}>BeerMenus</a>, which is the largest platform for locating craft beer with >40,000 bars, restaurants and beer stores participating.</p>
    
    <p>Early on as the sole employee I spent most of my time interacting with customers learning what the company and product should eventually become.</p>
    
    <p>Once we found product-market fit with a subscription product for bars and restaurants, we quickly realized the importance of retention and I developed our Customer Success department.</p>
    
    <p>As the company grew even more, I shifted my focus to developing new products and growing our audience of craft beer fans. This included scoping, roadmapping, testing, and launching new features. Working closely with our product team got me excited to dive deeper into the product side of the business in order to speed up our product launch cycle.</p>
